...
async def register(user: UserCreate):
    ...
    # for loop: Jab bhi apko same kam karna ho repeatively tw waha hum loop ka use karty hain jbhi yaha for ka use kia hai. 
    # loop do hoty hain for loop or while loop.
# http://127.0.0.1:8000/docs browser py ja kar es url py gaye Post /register py click kia then Try it out on click then 
# ("username": "string",) es ki jaga ("username": "abc",) ye likha or ("password": "string") es ki jaga ("password": "abc123")
# ye likha then Execute on click tw Response body py ye print ho gaya {"message": "User abc registered successfully"}
...
# upper register ka kam check krna ky bad GET /me Get Current User py click kia then Try it out on click then Execute on click 
# tw Response body main  {"username": "ali", or  "password": "$2b$12$gOo.VQWLnk3PndeJf9nJTetiHb0XzkDE2xgs4rsX24ykW8CFSMQF2"} ye aye ga.
